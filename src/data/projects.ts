...
export const projects: Project[] = [
  ...
  },
  {
    slug: "ram-hd",
    title: "Heavy Duty",
    subject: "RAM HD on Forged Wheels",
    category: "automotive",
    year: "2026",
    featured: true,
    summary: "Static hero frames on a timber bridge, then rolling coverage at dusk.",
    description: [
      "A black RAM Heavy Duty on polished forged wheels, shot as two halves: locked-off hero frames on an open timber bridge while the light was still soft, then rolling coverage once it dropped.",
